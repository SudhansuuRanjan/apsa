    ...
    <div className="bg-[#0b0b0b] text-sm w-[100%] mt-[10rem]">
      ...
      <div className="mb-10 w-[90%] grid gap-2 md:gap-4 lg:gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 m-[auto] items-start justify-items-center">
        ...
        <div data-aos="fade-up" className='mt-10 w-[100%] md:w-[100%] lg:w-[100%] order-1 md:order-1 lg:order-1'>
          ...
          <Link to="/">
            <img src="/images/logo.png" alt="logo" className='h-20 mb-2 w-auto' />
          </Link>

          <p className='max-w-[17rem] py-3 text-base'>APSA is the most active cultural and technical club of AIIMS Patna.</p>
          <div className='flex gap-3 py-2 '>
            <a style={{ textDecoration: "none" }} target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/apsa_AIIMSp/" >
            ...
            <a style={{ textDecoration: "none" }} target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/apsa-club-AIIMSp/" >
        ...
        <div data-aos="fade-up" className='mt-10 w-[100%] md:w-[100%] lg:w-[100%] order-2 md:order-2 lg:order-2'>
          ...
          <ul className='mt-4 flex flex-col gap-2 text-base'>
            ...
            <li className=' hover:text-blue-600'><Link style={{ textDecoration: "none" }} to="/resources/opportuAIIMSies"><p className='text-gray-400 hover:text-sky-500'>Opportunities</p></Link></li>
          </ul>
        </div>
        ...
        <div data-aos="fade-up" className='mt-10 w-[100%] md:w-[100%] lg:w-[100%] order-3 md:order-3 lg:order-3 text-base'>
          ...
          <p className='max-w-[16rem] pt-4 text'>AIIMS Patna, Phulwarisharif, Patna, Bihar-800005, India</p>
          ...
          <p className='pt-2'>Mail : <a style={{ textDecoration: "none" }} href="mailto:apsa@aiimsp.org" className='text-blue-700 ml-2 font-semibold'><span className='hover:text-gray-400 text-sky-500'>apsa@aiimsp.org</span></a></p>
        </div>
      ...
      <div className="m-[auto] py-7 text-gray-500 font-medium text-sm flex flex-col md:flex-row lg:flex-row justify-between items-center w-[90%]">
        <p>
          © {year} APSA AIIMSP. All Rights Reserved.
        </p>
        <p>
